    ...
    <div>
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-500">Update terbaru seputar lowongan dan pelamar Anda.</p>
        </div>
        ...
        <div className="mt-6 space-y-2">
          {notifications.map((n) => (
            <button
              ...
              className={`flex w-full items-start gap-3 rounded-xl border px-4 py-3 text-left transition-colors ${n.is_read ? "border-ink-100 bg-white" : "border-amber-200 bg-amber-50/40"}`}
            >
