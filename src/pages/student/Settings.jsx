  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-500">Kelola keamanan dan preferensi akun Anda.</p>
      </div>
      ...
      <div className="card p-6">
        ...
        <div className="mt-3 space-y-1 text-sm text-ink-600">
          ...
          <p><span className="text-ink-400">Role:</span> Student</p>
        </div>
      </div>
      ...
      <div className="card space-y-3 p-6">
        ...
        <button onClick={() => setConfirmLogout(true)} className="btn-outline">
